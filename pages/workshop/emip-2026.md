...
• Deadline for papers: ~~March 14th, 2026 (AoE)~~

Please note due to the tight timeline there will be **no extension**!

• Notification to authors: March 25th, 2026

• Camera-ready Deadline: March 30th, 2026 (AoE)

• Workshop: June 2026 @ ETRA
...
|---|---|
| Alaa Ismail, Zachary Kozak, Bonita Sharif | Analyzing Reading Behavior across Source Code and Stack Overflow for Method and Class Summarization |
| Timur Ezer, Jürgen Mottok | ClassShift: Improving Fixation-to-Class Assignment in UML Class Diagrams |
| Wudao Yang, M. A. Rasel, Seng Yue Wong, Unaizah Obaidellah | Cognitive Attention Map: Semantic Tokenization of Source Code via OCR-Based AOI Identification across Performance Levels |
| Kyogo Horikawa, Hidetake Uwano, Haruhiko Yoshioka | Identifying Effective Program Comprehension Strategies through Gaze Transitions over Syntactic Elements |
| Timur Ezer, Florian Hauser, Simon Röhrl, Jürgen Mottok | Inducing Global and Focal View in UML Class Diagram Comprehension |
