...
Your submission should be prepared following the [ETRA paper template instructions](http://etra.acm.org/2025/submissionprocess.html). Please use the ACM article template for all submissions with the `manuscript,review,anonymous` style.

When submitting your paper for review, your paper can contain up to 8 pages (single column, plus references). Please note that the accepted papers will be published as part of the ETRA Workshop Proceedings in the ACM double-column template.
